defmodule VideoTutorialsBackOffice.DataCase do
  @moduledoc """
  ...
  by setting `use VideoTutorialsServices.DataCase, async: true`, although
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import VideoTutorialsBackOffice.DataCase
    end
  end
