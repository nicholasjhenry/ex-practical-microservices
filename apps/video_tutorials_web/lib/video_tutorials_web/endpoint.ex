defmodule VideoTutorialsWeb.Endpoint do
  ...
  @session_options [
    store: :cookie,
    key: "_video_tutorials_web_key",
    signing_salt: "H+SeJi4I"
  ]
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :video_tutorials_web
  end
